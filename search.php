...
<nav class="navbar navbar-inverse navbar-fixed-top  ">
  <div class="container con">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Photo <span>zoom</span></a>
    </div>
                ...
                <div class="row">
                  <div class="col-sm-4 side ">
                   ...
                   <div class="info">
                      ...
                      <h6 class="afh">About · <a href="#"><i class="fa fa-pencil fa-fw"></i> Edit</a></h6>
  ...
  <!--************************ php post************************-->
              ...
              echo '<div class="post_p">';
                ...
                echo ' <div class="like text-right">';
                   ...
                   echo ' <span class=" b">'. $row["post_date"].'/'.$row["post_time"].'</span>';
                echo ' </div>';
             echo '</div>';
